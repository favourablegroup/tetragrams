...
function displayUpdate() {
    ...
    const updateMessages = [
        ...
        "The universe is composed of interacting fields,",
        "some at rest and some in motion. It is, in and of itself,",
        "one gigantic hologram of unbelievable complexity.",
        "According to the theories of Karl Pribram, of London,",
        "the human mind is also a hologram which attunes itself to",
        "the universal hologram by the medium of energy exchange",
        "thereby deducing meaning and achieving the state which we",
        "call consciousness.",
        "With respect to states of expanded or altered consciousness,",
        "the process operates in the following way:",
        "As energy passes through various fields which comprise",
        "the human mind, the holographic images being conveyed",
        "are projected upon those electrostatic fields of the mind",
        "and are perceived or understood to the extent that",
        "the electrostatic field is operating at a frequency and",
        "amplitude that can harmonize with and therefore \"read\"",
        "the energy carrier wave pattern passing through it.",
        "Changes in the frequency and amplitude of the electrostatic",
        "field which comprises the human mind determines the",
        "configuration and hence the character of the holographic",
        "energy matrix which the mind projects to intercept meaning",
        "directly from the holographic transmissions of the universe.",
        "Then, to make sense of what the holographic image is saying",
        "to it, the mind proceeds to compare the image just received",
        "with itself. Specifically, it does this by comparing",
        "the image received with that part of its own hologram",
